<%-- 
    ...
    Created on : 03-Dec-2023, 1:05:53 am
    Author     : sai vividh
--%>
...
<html>
    <head>
        ...
        <title>Appointments List page</title>
        <link rel="stylesheet"
                    ...
                    <div class="table100 ver3 m-b-110">
                            ...
                            <table>
                                <thead>
                                    <tr class="row100 head">
                                        ...
                                        <th class="cell100 column5">Reason of Visit</th>
                                        <th class="cell100 column6">Doctor Name</th>
                                        <th class="cell100 column7">Appointment Date</th>
                                    </tr>
                                </thead>
                            </table>
                        </div>
                        <%
                            try {
                                ...
                                if (query != null) {
                                    sql = "select * from appointment where fname like '%" + query + "%' or lname like '%" + query + "%' ";
                                } else {
